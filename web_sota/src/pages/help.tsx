import { Book, Code, Info, Terminal } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">
            Guide to using Readly MCP and its capabilities
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="border-slate-800 bg-slate-950/50 backdrop-blur-xl">
          ...
          <CardContent className="text-slate-400 space-y-4 text-sm">
            <p>
              Readly MCP is designed to capture and archive magazine content for
              personal digital libraries. It uses a headless browser to navigate
              content and compiles high-quality PDFs.
            </p>
            <div className="space-y-2">
              <div className="flex gap-2">
                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-slate-800 text-xs font-bold text-white">
                  1
                </span>
                <span>
                  Navigate to the Readly website using the AI command.
                </span>
              </div>
              <div className="flex gap-2">
                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-slate-800 text-xs font-bold text-white">
              ...
              <div className="flex gap-2">
                ...
                <span>
                  Run the `scrape_magazine` tool with your desired parameters.
                </span>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-slate-800 bg-slate-950/50 backdrop-blur-xl">
          ...
          <CardContent className="text-slate-400 space-y-4 text-sm">
            <p>
              Custom timing and page limits can be set in the Settings page or
              passed directly to the tool calls.
            </p>
        ...
        <Card className="border-slate-800 bg-slate-950/50 backdrop-blur-xl">
          ...
          <CardContent className="text-slate-400 space-y-4 text-sm">
            <p>If scraping fails, check the following:</p>
            <ul className="list-disc list-inside space-y-1">
