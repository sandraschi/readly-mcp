import { Box, Database, ExternalLink, Network } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">
            Network overview of all active MCP server interfaces
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {apps.map((app) => (
          <Card
            key={app.name}
            className="border-slate-800 bg-slate-950/50 hover:bg-slate-900/50 transition-all cursor-pointer group"
          >
