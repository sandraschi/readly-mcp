...
4. Start the server:
   ...
   uv run python -m readly_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn readly_mcp.server:app --port 10846
   ```
5. Open `http://localhost:10846` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/readly-mcp/issues) |
